# Gitea Act Runner — generated, do not edit

Everything in this directory is generated from `templates/specs/services/act-runner.yaml` — do
...
- To add a hand-written companion service (e.g. a `-cli`/`-init`
  `extends:` companion), put it under `templates/services/custom/act-runner/`
