# Docker Socket Proxy — generated, do not edit

Everything in this directory is generated from `templates/specs/services/docker-socket-proxy.yaml` — do
...
- To add a hand-written companion service (e.g. a `-cli`/`-init`
  `extends:` companion), put it under `templates/services/custom/docker-socket-proxy/`
