# Nginx Proxy Manager — generated, do not edit

Everything in this directory is generated from `templates/specs/services/nginx-proxy-manager.yaml` — do
...
- To add a hand-written companion service (e.g. a `-cli`/`-init`
  `extends:` companion), put it under `templates/services/custom/nginx-proxy-manager/`
