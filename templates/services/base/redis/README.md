# Redis — generated, do not edit

Everything in this directory is generated from `templates/specs/services/redis.yaml` — do
...
- To add a hand-written companion service (e.g. a `-cli`/`-init`
  `extends:` companion), put it under `templates/services/custom/redis/`
